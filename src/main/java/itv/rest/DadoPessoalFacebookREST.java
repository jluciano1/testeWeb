...
import itv.business.AcontecimentoFacebookBusiness;
import itv.business.DadoPessoalFacebookBusiness;
import itv.business.EducacaoFacebookBusiness;
...
public class DadoPessoalFacebookREST {
  ...
  public HttpEntity<PagedResources<DadoPessoalFacebook>> findByPessoaId(@PathVariable("pessoaId") java.lang.Integer id, Pageable pageable, PagedResourcesAssembler assembler) {
    return new ResponseEntity<>(assembler.toResource(dadoPessoalFacebookBusiness.findByPessoaId(id, pageable)), HttpStatus.OK);
  }
